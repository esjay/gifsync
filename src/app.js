...
function init(paramsString) {
    ...
    let canonicalVideoUrl = '',
        videoId, webmUrl, mp4Url, fallbackUrl;
    ...
    function setPageWideListeners() {
        document.querySelector('#unpause').addEventListener('click', (e) => {
            console.log('click', e)
            attemptToPlayBoth()
        })
    }
